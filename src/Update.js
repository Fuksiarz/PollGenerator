...
function Update() {
    ...
    const setQuestionAndAnswers=(fromDb, params)=>{
    ...
    const hereWeSetServiceList= ()=>{

        serviceListData.map((xde) => {
            if(xde.id === params){
                xde.answer.map((data) => {

                    console.log(JSON.stringify(data.answer[1]))
                    setList(data.answer.value)
                })
            }
                                ...
                                <div className="forQuestion">
                                    ...
                                    <div>
                                        <input className="inputQuestion" name="question" type="text" required
                                               value= {post.question} onChange={(event) => setQuestion(event.target.value)}
                                        />
                                    </div>
                                </div>
